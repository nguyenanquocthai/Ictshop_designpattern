        ...
        public ActionResult Edit(Sanpham sanpham)
        {
            try
            {
                ...
                var builder = new SanphamBuilder()
                    ...
                    .SetGiatien(sanpham.Giatien)
                    .SetSoluong(sanpham.Soluong)
                    .SetMota(sanpham.Mota)
                    .SetAnhbia(sanpham.Anhbia)
                    .SetBonhotrong(sanpham.Bonhotrong)
                    .SetRam(sanpham.Ram)
                    .SetThesim(sanpham.Thesim)
                    .SetMahang(sanpham.Mahang)
                    .SetMahdh(sanpham.Mahdh);
