...
namespace Ictshop.Areas.Admin.Controllers
{
    public class DonhangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Madon,Ngaydat,Tinhtrang,Thanhtoan,MaNguoidung,Diachinhanhang")] Donhang donhang)
        {
            ...
            {
                donhang.State = new DonhangStatePending(); // Ban đầu đơn hàng ở trạng thái chờ xử lý
        ...
        public ActionResult Xacnhan(int? id)
        {
            ...
            donhang.State = new DonhangStateConfirmed(); // Xác nhận đơn hàng
            donhang.ProcessState(); // Thực hiện xử lý trạng thái
            db.SaveChanges();
